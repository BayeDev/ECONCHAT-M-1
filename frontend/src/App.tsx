        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold flex items-center gap-2" style={{ fontFamily: 'var(--font-display)' }}>
              ...
              EconChat
              <span className="text-sm font-normal bg-blue-700/60 px-2 py-0.5 rounded-full ml-1">M-2</span>
            </h1>
            <p className="text-blue-200 text-sm" style={{ fontFamily: 'var(--font-body)' }}>AI-powered economic data assistant</p>
          </div>
